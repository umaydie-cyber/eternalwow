...
const SKILLS = {
    ...
    blizzard: {
        ...
        name: '冰风暴',
        icon: '🌨️',
        iconUrl : 'icons/wow/vanilla/spells/Spell_Frost_IceShard.png',
        type: 'dot',
        limit: 2,
    ...
    frozen_orb: {
        ...
        name: '寒冰宝珠',
        icon: '🔮',
        iconUrl : 'icons/wow/vanilla/spells/Spell_Frost_Stun.png',
        type: 'aoe_dot',
        limit: 2,
    ...
    comet_storm: {
        ...
        name: '彗星风暴',
        icon: '☄️',
        iconUrl : 'icons/wow/vanilla/spells/Spell_Frost_ChillingBlast.png',
        type: 'aoe_damage',
        limit: 1,
