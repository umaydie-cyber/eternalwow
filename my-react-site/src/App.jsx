...
const initialState = {
    ...
    questProgress: {
        ...
        //     completedBranch: null  // 'suppress_vancleef' 或 'slay_prestor'
        // }
    },
    questItems: [],  // 任务物品
    completedQuestBranches: [],  // 已完成的任务分支（用于成就等）
    questTitles: []  // 获得的称号
};
            ...
            return {
                ...
                questProgress: {
                    ...
                    [questId]: {
                        ...
                        currentStep: Object.keys(quest.steps)[0],  // 第一步
                        flags: [],
                        completedSteps: [],
